...
$listings = Listingdetails::find()->joinWith('shoeImage')->limit(4)->all();
$lists = Listingdetails::find()->orderBy(['listingId'=>SORT_DESC])->joinWith('shoeImage')->limit(4)->all();
